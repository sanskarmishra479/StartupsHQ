...
| [ARCHITECTURE.md](./ARCHITECTURE.md) | **How is it put together, and why?** | Layering, lifecycles, caching, ops, cost model, Decision Records (ADR-001 … ADR-022) | Before changing anything structural |
